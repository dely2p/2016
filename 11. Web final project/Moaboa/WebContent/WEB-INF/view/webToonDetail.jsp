...
<script type="text/javascript">
  	...
  	function test(i, j){
  		window.open("http://comic.naver.com/webtoon/detail.nhn?titleId="+ ${webToonDetail.titleId }+"&no="+ j,"_blank");
  		window.open("poprecorder.html", "moaboa_player", 'scrollbars=no,toolbar=no,location=no,resizable=no,status=no,menubar=no,resizable=no,width=200,height=100,left=1300,top=100');
  		
  		

  		/* console.log("http://comic.naver.com/webtoon/detail.nhn?titleId="+ ${webToonDetail.titleId }+"&no="+ j); */
  	}
</script>
